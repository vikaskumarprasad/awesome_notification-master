...
class NotificationUtils {
  ...
  Future<void> configuration() async {
    log("configuration check with this");
  ...
  static Future<void> onActionReceivedMethod(
    ...
    if (receivedAction.actionType == ActionType.SilentAction ||
      ...
      log("check data with receivedAction 3$receivedAction");
  ...
  static Future<void> onActionReceivedImplementationMethod(
      ReceivedAction receivedAction) async {
    log("check data with receivedAction${MyApp.navigatorKey.currentState}");
    log("check data with receivedAction${MyApp.navigatorKey.currentContext}");
